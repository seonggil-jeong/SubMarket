...
public interface ItemRepository extends JpaRepository<ItemEntity, Integer> {
    ...
    @Transactional
    @Query(value = "UPDATE ITEM SET itemStatus = 0 WHERE itemSeq = :itemSeq", nativeQuery = true)
    int offItemStatus(@Param("itemSeq") int itemSeq);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET itemStatus = 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    ...
    @Query(value = "UPDATE ITEM SET itemContents = :itemContents, itemPrice = :itemPrice, itemCount = :itemCount," +
            "itemTitle = :itemTitle WHERE itemSeq = :itemSeq", nativeQuery = true)
    ...
    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET itemCount = itemCount - 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    ...
    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount20 = readCount20 + 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseReadCount20(@Param("itemSeq") int itemSeq);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount30 = readCount30 + 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseReadCount30(@Param("itemSeq") int itemSeq);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount40 = readCount40 + 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseReadCount40(@Param("itemSeq") int itemSeq);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount_other = readCountOther + 1 WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseReadCountOther(@Param("itemSeq") int itemSeq);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount20 = readCount20 + :readValue WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseCustomReadCount20(@Param("itemSeq") int itemSeq, @Param("readValue") int readValue);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount30 = readCount30 + :readValue WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseCustomReadCount30(@Param("itemSeq") int itemSeq, @Param("readValue") int readValue);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCount40 = readCount40 + :readValue WHERE itemSeq = :itemSeq", nativeQuery = true)
    void increaseCustomReadCount40(@Param("itemSeq") int itemSeq, @Param("readValue") int readValue);

    @Modifying(clearAutomatically = true)
    @Transactional
    @Query(value = "UPDATE ITEM SET readCountOther = readCountOther + :readValue WHERE itemSeq = :itemSeq", nativeQuery = true)
